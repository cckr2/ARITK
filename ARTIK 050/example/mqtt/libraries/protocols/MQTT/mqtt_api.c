...
wiced_result_t wiced_mqtt_connect( wiced_mqtt_object_t mqtt_obj, wiced_ip_address_t *address, wiced_interface_t interface, wiced_mqtt_callback_t callback, wiced_mqtt_security_t *security, wiced_bool_t onlyTLS, wiced_mqtt_pkt_connect_t *conninfo )
{
    mqtt_connection_t *conn = (mqtt_connection_t*) mqtt_obj;
    wiced_result_t result = WICED_SUCCESS;
    ...
    result = mqtt_connection_init( address, conninfo->port_number, interface, callback, conn, security, onlyTLS );
