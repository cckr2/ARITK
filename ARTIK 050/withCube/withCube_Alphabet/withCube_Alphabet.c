...
static int outHigh[3],outLow[3],square[3];
...
#define CLIENT_ID		"g6fr43s4f52s"
#define TOPIC 			"/v1.1/messages/9207a4e8547c47ee8b75b17ef4c691fd"
...
static void lis3dh_run(){
	int i, dir_count;
	int dir, real_dir, current_dir, prev_dir;
	...
	while(1){
		...
		if(dir_count==10){
			...
			dir_count=0;
			switch(dir){
			case 0:sprintf(message, msg, CUBE_TYPE, CUBE_NUM, "+z",0);break;
			case 1:sprintf(message, msg, CUBE_TYPE, CUBE_NUM, "+y",0);break;
			case 2:sprintf(message, msg, CUBE_TYPE, CUBE_NUM, "+x",0);break;
			case 3:sprintf(message, msg, CUBE_TYPE, CUBE_NUM, "-z",0);break;
			case 4:sprintf(message, msg, CUBE_TYPE, CUBE_NUM, "-y",0);break;
			case 5:sprintf(message, msg, CUBE_TYPE, CUBE_NUM, "-x",0);break;
			}
...
//    conninfo.password = DEVICE_ID;
//    conninfo.username = DEVICE_TOKEN;
    conninfo.username = "9207a4e8547c47ee8b75b17ef4c691fd";
    conninfo.password = "ecd397294c9e4a7abafff1c09b9f151a";
